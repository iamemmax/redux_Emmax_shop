...
// filter product by cartegoruy
export const filterProduct = (payload) => async (dispatch) =>{
    dispatch({type:FILTER_WARES, payload})
    dispatch({type:FILTER_SHOE, payload})
}